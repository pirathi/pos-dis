...
@section('content')
    <div class="login-form col-md-12 col-xs-12">

        <div class="logcontainer" style="margin-top: 8%;">
            <div class="signup-content">
                <div class="signup-form">
                        ...
                        @endif
                    <h3 class="form-title">@lang('lang_v1.login')</h3>
                    <form method="POST" action="{{ route('login') }}" id="login-form">
                        ...
                        <div class="form-group">
                            <div class="checkbox icheck">
                                <label>
                                    <small><p style="font-size: 16px;"><input type="checkbox" name="remember" {{ old('remember') ? 'checked' : '' }}> @lang('lang_v1.remember_me')</p></small>
                                </label>
                            <a href="{{ route('password.request') }}" style="text-decoration: none; font-size: 14px;">
                        ...
                        <br>
                        <div class="form-group">
                            <button type="submit" class="btn btn-lg btn-primary btn-flat btn-login">@lang('lang_v1.login')</button>
                            
                        </div>
                    </form>
                </div>
                <div class="signup-image ">
                    <figure><img src="/uploads/media/signup-image.png" alt="sing up image"></figure>
                </div>
            </div>
        </div>
        <p class="form-header text-white"></p>
